...
public class AIBat : MonoBehaviour
{
	...
	private BatAttack batAttack; // Tham chiếu đến lớp tấn công
	private BatHealth batHealth; // Thêm tham chiếu tới SkeletonHealth
	...
	private void Update()
	{
		...
		if (batHealth == null || batHealth.IsDead())
		{
			return;
		}
		...
		else
		{
			...
			batAttack?.TryDealDamage(player);
		}
	}
